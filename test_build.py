...
def build_test_vehicles():
    test_vehicles = {
        "HRR_scout_car_1": ["ASR-I-CARRO", "anser scout car", 3, 2, 1, 0, "TRACKED", "", "", "", "", [0, 0], 15,
        ...
        "HRR_heavy_infantry_mortar": ["MGN-MORTIER", "heavy mortar", 0, 0, 1, 0, "GUN_CARRIAGE", "", "",
        ...
        "VIN_scout_car_2": ["DF-6-VOGN", "dverg scout car", 3, 2, 1, 1, "WHEELED", "light autocannon", "",
        ...
        "VIN_medium_truck_cargo": ["LASTBIL-1", "lastbil truck", 2, 2, 1, 0, "WHEELED", "", "", "", "", [0, 0], 25,
                                   ["STORAGE", "LOADER", "", ""], "SUPPLY", 0, 5],
        "VIN_medium_truck_hauler": ["LASTBIL-1", "lastbil truck", 2, 2, 1, 0, "WHEELED", "", "", "", "", [0, 0], 25,
                                    ["", "", "", ""], "HOLD", 0, 5],
        ...
        "VIN_medium_anti_tank_gun": ["KN-23-KANON ", "medium gun", 0, 0, 1, 0, "GUN_CARRIAGE", "", "", "medium gun", "",
                                     [1, 0], 25, ["LOADER", "", "", ""], "HOLD", 1, 5],
        "VIN_light_anti_tank_gun": ["NN-11-KANON", "light gun", 1, 1, 1, 0, "GUN_CARRIAGE", "", "", "light gun", "",
                                    [1, 0], 15, ["LOADER", "", "", ""], "HOLD", 1, 3],
        "VIN_prototype_rockets": ["RKN-15-RAKETKAST", "rocket launcher", 0, 0, 1, 0, "GUN_CARRIAGE", "", "",
...
def build_infantry():
    infantry = {"rm": ["RIFLE", "rifleman", 10, 6, "HOLD", ["RIFLES", "EXTRA_GRENADES", "PLACE_MINES", ""]],
                ...
                "en": ["ENGINEER", "engineer", 10, 2, "HOLD", ["SIDE_ARMS", "REPAIR", "PLACE_MINES", "SATCHEL_CHARGE"]],
...
def build_weapons():
    ...
    for component_key in components:
        ...
        if component_type == "weapon":
            ...
            small_caliber = rating < 3
            large_caliber = rating > 3
...
def build_actions():
    action_items = {
        "BAIL_OUT": ["bail_out", "ORDERS", 1, 0, 0, "SELF", "BAILING_OUT", "NEVER", 0, 0, 0, 0, 0, 0, 0, 0, ""],
        "CLEAR_JAM": ["cancel", "ORDERS", 1, 0, 0, "SELF", "CLEAR_JAM", "NORMAL", 0, 0, 0, 0, 0, 0, 0, 0, ""],
        "CREW": ["crew", "ORDERS", 1, 0, 0, "FRIEND", "CREW", "SUPPLY", 0, 0, 0, 0, 0, 0, 0, 0, ""],
        "CALL_REINFORCEMENTS": ["crew", "ORDERS", 2, 0, 0, "SELF", "REINFORCEMENT", "NEVER", 1, 1, 0, 0, 0, 0, 0, 0,
                                ""],
        "EMERGENCY_REPAIR": ["repair", "ORDERS", 2, 0, 0, "SELF", "EMERGENCY_REPAIR", "NEVER", 0, 1, 0, 0, 0, 0, 0, 0,
                             ""],
        "GRAB_SUPPLIES": ["supply", "ORDERS", 2, 0, 0, "SELF", "GRAB_SUPPLIES", "NEVER", 1, 1, 0, 0, 0, 0, 0, 0, ""],
        "DIRECT_ORDER": ["radio", "ORDERS", 2, 3, 1, "ALLIES", "DIRECT_ORDER", "DEFENSIVE_SUPPORT", 0, 0, 0, 0, 0, 0, 0,
                         0, ""],
        "ENTER_BUILDING": ["building", "ORDERS", 1, 0, 0, "BUILDING", "ENTER_BUILDING", "NEVER", 0, 0, 0, 0, 0, 0, 0, 0,
                           ""],
        "FAST_RELOAD": ["supply", "ORDERS", 1, 6, 0, "SELF", "FAST_RELOAD", "NEVER", 0, 0, 0, 0, 0, 0, 0, 0, ""],
        "COMMANDER": ["crew", "ORDERS", 1, 6, 1, "SELF", "COMMANDER", "NEVER", 0, 0, 3, 0, 0, 0, 0, 0, ""],
        "LOAD_TROOPS": ["load", "ORDERS", 1, 0, 0, "FRIEND", "LOAD_TROOPS", "NEVER", 0, 0, 0, 0, 0, 0, 0, 0, ""],
        ...
        "TARGET_RECOGNITION": ["spotting", "ORDERS", 2, 3, 1, "ENEMY", "RECOGNITION", "OFFENSIVE_SUPPORT", 0, 0, 0, 0,
                               0, 0, 0, 0, ""],
        "RADIO_CONFUSION": ["jamming", "ORDERS", 1, 3, 1, "ENEMY", "CONFUSION", "OFFENSIVE_SUPPORT", 0, 0, 0, 0, 0, 0,
                            0, 0, ""],
        "RADIO_JAMMING": ["jamming", "ORDERS", 1, 3, 1, "ENEMY", "RADIO_JAMMING", "OFFENSIVE_SUPPORT", 0, 0, 0, 0, 0, 0,
                          0, 0, ""],
        "CHANGE_FREQUENCIES": ["radio", "ORDERS", 1, 0, 0, "SELF", "REMOVE_JAMMING", "NORMAL", 0, 0, 0, 0, 0, 0, 0, 0,
                               ""],
        "MOVE": ["move", "ORDERS", 0, 0, 0, "MOVE", "MOVE", "NORMAL", 0, 0, 0, 0, 0, 0, 0, 0, ""],
        "OVERDRIVE": ["wheels", "ORDERS", 0, 3, 1, "SELF", "OVERDRIVE", "NEVER", 0, 0, 3, 0, 0, 0, 0, 0, ""],
        "PLACE_MINES": ["mines", "ORDERS", 2, 1, 0, "SELF", "PLACE_MINE", "NEVER", 0, 1, 0, 0, 0, 0, 0, 0, ""],
        "QUICK_MARCH": ["wheels", "ORDERS", 2, 3, 1, "ALLIES", "SET_QUICK_MARCH", "DEFENSIVE_SUPPORT", 0, 0, 0, 0, 0, 0,
                        0, 0, ""],
        "RAPID_FIRE": ["rapid_fire", "ORDERS", 1, 4, 1, "SELF", "RAPID_FIRE", "DEFEND", 0, 1, 3, 0, 0, 0, 0, 0, ""],
        "RECOVER_MORALE": ["crew", "ORDERS", 1, 0, 1, "ALLIES", "RECOVER", "DEFENSIVE_SUPPORT", 0, 0, 0, 0, 0, 0, 0, 0,
                           ""],
        "REARM_AND_RELOAD": ["supply", "ORDERS", 1, 0, 0, "FRIEND", "RELOAD", "SUPPLY", 0, 0, 0, 0, 0, 0, 0, 0, ""],
        "REMOVE_MINES": ["mines", "ORDERS", 2, 1, 0, "SELF", "REMOVE_MINE", "NORMAL", 0, 1, 0, 0, 0, 0, 0, 0, ""],
        "REPAIR": ["repair", "ORDERS", 1, 0, 0, "FRIEND", "REPAIR", "SUPPLY", 0, 0, 0, 0, 0, 0, 0, 0, ""],
        "FACE_TARGET": ["rotate", "ORDERS", 0, 0, 0, "MOVE", "ROTATE", "NORMAL", 0, 0, 0, 0, 0, 0, 0, 0, ""],
        "REDEPLOY": ["rotate", "ORDERS", 1, 0, 0, "MOVE", "ROTATE", "NORMAL", 0, 0, 0, 0, 0, 0, 0, 0, ""],
        "OVERWATCH": ["radio", "ORDERS", 2, 3, 0, "SELF", "SET_OVERWATCH", "DEFEND", 0, 1, 0, 0, 0, 0, 0, 0, ""],
        "SPOTTING": ["spotting", "ORDERS", 2, 0, 0, "SELF", "SPOTTING", "NEVER", 0, 1, 0, 0, 0, 0, 0, 0, ""],
        "STEADY_AIM": ["aimed_shot", "ORDERS", 1, 4, 1, "SELF", "STEADY_AIM", "DEFEND", 0, 1, 3, 0, 0, 0, 0, 0, ""],
        "SPECIAL_AMMO": ["rapid_fire", "ORDERS", 1, 4, 1, "SELF", "SPECIAL_AMMO", "DEFEND", 0, 1, 3, 0, 0, 0, 0, 0, ""],
        "TOGGLE_BUTTONED_UP": ["stance", "ORDERS", 1, 0, 0, "SELF", "TOGGLE_BUTTONED_UP", "NORMAL", 0, 0, 0, 0, 0, 0, 0,
                               0, ""],
        "TOGGLE_STANCE": ["stance", "ORDERS", 1, 0, 0, "SELF", "TOGGLE_PRONE", "NORMAL", 0, 0, 0, 0, 0, 0, 0, 0, ""],
        "AMBUSH": ["spotting", "ORDERS", 2, 1, 0, "SELF", "TRIGGER_AMBUSH", "NEVER", 0, 1, 0, 0, 0, 0, 0, 0, ""],
        "ANTI_AIRCRAFT_FIRE": ["aa_fire", "ORDERS", 2, 1, 0, "SELF", "TRIGGER_ANTI_AIRCRAFT", "ANTI_AIR", 0, 1, 0, 0, 0,
                               0, 0, 0, ""],
        "UNLOAD_TROOPS": ["unload", "ORDERS", 1, 0, 0, "SELF", "UNLOAD_TROOPS", "NEVER", 0, 1, 0, 0, 0, 0, 0, 0, ""],
        "SPOTTER_PLANE": ["camera", "ORDERS", 2, 12, 1, "AIRCRAFT", "SPOTTER_PLANE", "AIR_SUPPORT", 0, 1, 0, 0, 0, 0, 0,
                          0, ""],
        "PARADROP": ["paradrop", "ORDERS", 2, 12, 1, "AIRCRAFT", "DROP_TROOPS", "AIR_SUPPORT", 0, 1, 0, 0, 0, 0, 0, 0,
                     ""],
        "AIR_STRIKE": ["plane", "ORDERS", 2, 12, 1, "AIRCRAFT", "AIR_STRIKE", "AIR_SUPPORT", 0, 1, 0, 0, 0, 0, 3, 0,
                       ""],
        "ARTILLERY_SHOT": ["explosion", "WEAPON", 1, 3, 0, "MAP", "ARTILLERY_EXPLOSION", "ARTILLERY", 0, 0, 0, 0.8, 0.5,
                           2, 1, 2, ""],
        "ZEROED_ARTILLERY": ["zeroed", "WEAPON", 1, 3, 1, "MAP", "ARTILLERY_EXPLOSION", "ARTILLERY", 0, 0, 0, 1, 0.5, 2,
                             1, 2, ""],
        "RANGED_SUPPORT_FIRE": ["explosion", "WEAPON", 1, 2, 0, "MAP", "ARTILLERY_EXPLOSION", "ARTILLERY", 0, 0, 0, 0.1,
                                0.5, 1.5, 1, 2, ""],
        "CLOSE_SUPPORT_FIRE": ["zeroed", "WEAPON", 1, 0, 0, "ENEMY", "ARTILLERY_EXPLOSION", "DIRECT_ATTACK", 0, 0, 0, 1,
                               0.5, 1.5, 1, 2, ""],
        "HIGH_EXPLOSIVE": ["explosion", "WEAPON", 1, 3, 0, "ENEMY", "HIT_SPLASH", "DIRECT_ATTACK", 0, 0, 0, 0.8, 0.5, 2,
                           1, 2, ""],
        "THROW_GRENADE": ["grenade", "WEAPON", 2, 3, 0, "ENEMY", "GRENADE_EXPLOSION", "DIRECT_ATTACK", 0, 0, 0, 0.6, 2,
                          2, 1, 4, ""],
        "SATCHEL_CHARGE": ["explosion", "WEAPON", 2, 3, 0, "ENEMY", "GRENADE_EXPLOSION", "DIRECT_ATTACK", 0, 0, 0, 0, 4,
                           4, 1, 6, ""],
        "RIFLE_GRENADE": ["rifles", "WEAPON", 2, 3, 0, "ENEMY", "HIT_SPLASH", "DIRECT_ATTACK", 0, 0, 0, 0.8, 2, 4, 1, 4,
                          ""],
        "SHOOT": ["shoot", "WEAPON", 1, 0, 0, "ENEMY", "HIT", "DIRECT_ATTACK", 0, 0, 0, 1, 1.2, 1.2, 1, 1, ""],
        "RIFLES": ["rifles", "WEAPON", 2, 0, 0, "ENEMY", "HIT", "DIRECT_ATTACK", 0, 0, 0, 1.5, 1, 1, 2, 2, ""],
        "SNIPER_RIFLES": ["aimed_shot", "WEAPON", 2, 0, 0, "ENEMY", "HIT", "DIRECT_ATTACK", 0, 0, 0, 2, 2, 3, 1, 1, ""],
        "ASSAULT_RIFLES": ["rifles", "WEAPON", 1, 0, 0, "ENEMY", "HIT", "DIRECT_ATTACK", 0, 0, 0, 1, 0, 1, 3, 1, ""],
        "HEAVY_RIFLES": ["rifles", "WEAPON", 2, 0, 0, "ENEMY", "HIT", "DIRECT_ATTACK", 0, 0, 0, 1.2, 4, 4, 2, 4, ""],
        "SMG": ["smg", "WEAPON", 1, 0, 0, "ENEMY", "HIT", "DIRECT_ATTACK", 0, 0, 0, 1, 0, 1, 4, 1, ""],
        "SIDE_ARMS": ["side_arms", "WEAPON", 1, 0, 0, "ENEMY", "HIT", "DIRECT_ATTACK", 0, 0, 0, 0.8, 0, 1, 3, 1, ""],
        "SUPPORT_FIRE": ["support_fire", "WEAPON", 2, 0, 0, "ENEMY", "HIT", "DIRECT_ATTACK", 0, 0, 0, 1, 1, 1, 12, 1,
                         ""],
        "HEAVY_SUPPORT_FIRE": ["support_fire", "WEAPON", 2, 0, 0, "ENEMY", "HIT", "DIRECT_ATTACK", 0, 0, 0, 1, 2, 2, 9,
                               1, ""],
        "DAMAGE_TRACKS": ["tracks", "WEAPON", 2, 3, 0, "ENEMY", "HIT_TRACKS", "DIRECT_ATTACK", 0, 0, 0, 1, 1, 1, 2, 1,
                          ""],
        "BURST_FIRE": ["rapid_fire", "WEAPON", 1, 0, 0, "ENEMY", "HIT", "DIRECT_ATTACK", 0, 0, 0, 1, 1, 1, 4, 1, ""],
        "RAPID_BURST": ["rapid_fire", "WEAPON", 1, 0, 0, "ENEMY", "HIT", "DIRECT_ATTACK", 0, 0, 0, 1, 1, 1, 6, 1, ""],
        "ANTI_TANK": ["anti_tank", "WEAPON", 1, 0, 0, "ENEMY", "HIT", "DIRECT_ATTACK", 0, 0, 0, 1.2, 1.8, 1, 1, 1, ""],
        "AIMED_SHOT": ["aimed_shot", "WEAPON", 1, 3, 0, "ENEMY", "HIT", "DIRECT_ATTACK", 0, 0, 0, 1.5, 1.2, 1.2, 1, 1,
                       ""],
        "CALLED_SHOT": ["aimed_shot", "WEAPON", 1, 3, 1, "ENEMY", "HIT", "DIRECT_ATTACK", 0, 0, 0, 1, 1.2, 1, 1, 4, ""],
        "QUICK_FIRE": ["rapid_fire", "WEAPON", 0, 3, 1, "ENEMY", "HIT", "DIRECT_ATTACK", 0, 0, 0, 1, 1, 1, 1, 1, ""],
        "ARMOR_PIERCING": ["aimed_shot", "WEAPON", 1, 0, 0, "ENEMY", "HIT", "DIRECT_ATTACK", 0, 0, 0, 1.2, 2.2, 1, 1, 2,
                           ""],
        "SUPPRESSING_FIRE": ["rapid_fire", "WEAPON", 1, 3, 1, "ENEMY", "HIT", "DIRECT_ATTACK", 0, 0, 0, 0.8, 1, 1, 8, 2,
                             ""],
        "TARGET_TRACKS": ["tracks", "WEAPON", 1, 3, 1, "ENEMY", "HIT_TRACKS", "DIRECT_ATTACK", 0, 0, 0, 0.8, 1, 1, 1, 1,
                          ""],
        "SMALL_ROCKETS": ["rockets", "WEAPON", 1, 3, 0, "MAP", "ROCKET_EXPLOSION", "ARTILLERY", 0, 1, 0, 0.6, 0.5, 1.5,
                          12, 3, ""],
        "MEDIUM_ROCKETS": ["rockets", "WEAPON", 1, 3, 0, "MAP", "ROCKET_EXPLOSION", "ARTILLERY", 0, 1, 0, 0.3, 0.5, 2,
                           9, 3, ""],
        "LARGE_ROCKETS": ["rockets", "WEAPON", 1, 3, 0, "MAP", "ROCKET_EXPLOSION", "ARTILLERY", 0, 1, 0, 0, 0.5, 2.5, 6,
                          3, ""],
        "SMOKE_ROCKETS": ["smoke", "WEAPON", 1, 3, 1, "MAP", "ROCKET_SMOKE", "SMOKE", 0, 1, 0, 0.3, 0, 0, 6, 0, ""],
        "SMOKE_SHELLS": ["smoke", "WEAPON", 1, 1, 0, "MAP", "SMOKE", "SMOKE", 0, 0, 0, 0.6, 0, 0, 1, 0, ""]}
...
def build_buildings():
    test_buildings = {"large_stone_1": ["large stone house", 2, 2, 1, 0, 3, 240, 1, "town"],
                      "large_stone_2": ["large stone house", 2, 3, 1, 0, 3, 280, 1, "town"],
                      "large_stone_3": ["large stone house", 2, 2, 1, 0, 3, 240, 1, "town"],
                      "large_stone_4": ["large stone house", 2, 2, 1, 0, 3, 200, 1, "town"],
                      "large_stone_5": ["large stone house", 2, 2, 1, 0, 3, 200, 1, "town"],
                      "large_shed_1": ["large shed", 3, 3, 1, 1, 2, 240, 1, "town"],
                      "large_shed_2": ["large shed", 3, 2, 1, 1, 2, 240, 1, "town"],
                      "large_shed_3": ["large shed", 2, 2, 1, 1, 2, 180, 1, "town"],
                      "large_shed_4": ["large shed", 3, 3, 1, 1, 3, 320, 1, "town"],
                      "large_shed_5": ["large shed", 3, 2, 1, 1, 3, 320, 1, "town"],
                      "large_shed_6": ["large shed", 3, 2, 1, 1, 2, 240, 1, "town"],
                      "large_shed_7": ["large shed", 3, 2, 1, 1, 2, 240, 1, "town"],
                      "long_stone_1": ["long stone house", 2, 2, 1, 0, 2, 180, 1, "town"],
                      "long_stone_2": ["long stone house", 2, 2, 1, 0, 2, 180, 1, "town"],
                      "long_stone_3": ["long stone house", 2, 2, 1, 0, 2, 180, 1, "town"],
                      "long_stone_4": ["long stone house", 2, 2, 1, 0, 2, 180, 1, "town"],
                      "long_stone_5": ["long stone house", 2, 2, 1, 0, 2, 180, 1, "town"],
                      "supplies_1": ["supplies", 1, 1, 0, 1, 1, 60, 0, "military"],
                      "supplies_2": ["supplies", 1, 1, 0, 1, 1, 60, 0, "military"],
                      "supplies_3": ["supplies", 1, 1, 0, 1, 1, 60, 0, "military"],
                      "supplies_4": ["supplies", 1, 1, 0, 1, 1, 60, 0, "military"],
                      "tents_1": ["tent", 1, 1, 1, 0, 1, 40, 0, "military"],
                      "tents_2": ["tent", 1, 1, 1, 0, 1, 40, 0, "military"],
                      "tents_3": ["tent", 1, 1, 1, 0, 1, 40, 0, "military"],
                      "tents_4": ["tent", 1, 1, 1, 0, 1, 40, 0, "military"],
                      "tents_5": ["tent", 2, 1, 1, 0, 1, 60, 0, "military"],
                      "tents_6": ["tent", 2, 1, 1, 0, 1, 60, 0, "military"],
                      "church_1": ["church", 3, 3, 1, 0, 3, 320, 1, "town"],
                      "church_2": ["church", 3, 3, 1, 0, 3, 320, 1, "town"],
                      "church_3": ["church", 3, 2, 1, 0, 3, 260, 1, "town"],
                      "church_4": ["church", 3, 2, 1, 0, 3, 260, 1, "town"],
                      "watchtower_1": ["watchtower", 1, 1, 1, 0, 4, 140, 0, "military"],
                      "watchtower_2": ["watchtower", 1, 1, 1, 0, 4, 140, 0, "military"],
                      "watchtower_3": ["watchtower", 1, 1, 1, 0, 4, 140, 0, "military"],
                      "watchtower_4": ["watchtower", 1, 1, 1, 0, 4, 140, 0, "military"],
                      "watchtower_5": ["watchtower", 1, 1, 1, 0, 4, 80, 0, "military"],
                      "watchtower_6": ["watchtower", 1, 1, 1, 0, 4, 80, 0, "military"],
                      "watchtower_7": ["watchtower", 1, 1, 1, 0, 4, 80, 0, "military"],
                      "watchtower_8": ["watchtower", 1, 1, 1, 0, 4, 80, 0, "military"],
                      "stone_house_1": ["stone house", 1, 1, 1, 0, 2, 160, 1, "town"],
                      "stone_house_2": ["stone house", 1, 1, 1, 0, 2, 160, 1, "town"],
                      "stone_house_3": ["stone house", 1, 1, 1, 0, 2, 160, 1, "town"],
                      "stone_house_4": ["stone house", 1, 1, 1, 0, 2, 160, 1, "town"],
                      "crates_1": ["crates", 1, 1, 0, 0, 2, 100, 0, "misc"],
                      "crates_2": ["crates", 1, 1, 0, 0, 2, 100, 0, "misc"],
                      "crates_3": ["crates", 1, 1, 0, 0, 2, 100, 0, "misc"],
                      "crates_4": ["crates", 1, 1, 0, 0, 2, 100, 0, "misc"],
                      "water_tower_1": ["water tower", 1, 1, 0, 0, 2, 48, 1, "misc"],
                      "water_tower_2": ["water tower", 1, 1, 0, 0, 2, 48, 1, "misc"],
                      "small_stone_1": ["small stone building", 1, 1, 1, 0, 2, 140, 1, "village"],
                      "small_stone_2": ["small stone building", 1, 1, 1, 0, 2, 140, 1, "village"],
                      "small_stone_3": ["small stone building", 1, 1, 1, 0, 2, 140, 1, "village"],
                      "small_stone_4": ["small stone building", 1, 1, 1, 0, 2, 140, 1, "village"],
                      "small_stone_5": ["small stone building", 1, 1, 1, 0, 2, 140, 1, "village"],
                      "small_stone_6": ["small stone building", 1, 1, 1, 0, 2, 140, 1, "village"],
                      "small_stone_7": ["small stone building", 1, 1, 1, 0, 2, 140, 1, "village"],
                      "small_stone_8": ["small stone building", 1, 1, 1, 0, 2, 140, 1, "village"],
                      "wooden_house_1": ["wooden house", 1, 1, 1, 0, 2, 100, 0, "village"],
                      "wooden_house_2": ["wooden house", 1, 1, 1, 0, 2, 100, 0, "village"],
                      "wooden_house_3": ["wooden house", 1, 1, 1, 0, 2, 100, 0, "village"],
                      "wooden_house_4": ["wooden house", 1, 1, 1, 0, 2, 100, 0, "village"],
                      "wooden_house_5": ["wooden house", 1, 1, 1, 0, 2, 100, 0, "village"],
                      "wooden_house_6": ["wooden house", 1, 1, 1, 0, 2, 140, 0, "village"],
                      "wooden_house_7": ["wooden house", 1, 1, 1, 0, 2, 140, 0, "village"],
                      "wooden_shack_1": ["wooden shack", 1, 1, 1, 0, 2, 100, 0, "village"],
                      "wooden_shack_2": ["wooden shack", 1, 1, 1, 0, 2, 100, 0, "village"],
                      "wooden_shack_3": ["wooden shack", 1, 1, 1, 0, 2, 100, 0, "village"],
                      "wooden_shack_4": ["wooden shack", 1, 1, 1, 0, 2, 100, 0, "village"],
                      "wooden_shack_5": ["wooden shack", 1, 1, 1, 0, 2, 100, 0, "village"],
                      "wooden_shack_6": ["wooden shack", 1, 1, 1, 0, 2, 60, 0, "village"],
                      "wooden_shack_7": ["wooden shack", 1, 1, 1, 0, 2, 60, 0, "village"],
                      "wooden_shack_8": ["wooden shack", 1, 1, 1, 0, 2, 60, 0, "village"],
                      "bunker_1": ["bunker", 1, 1, 1, 0, 2, 160, 2, "military"],
                      "bunker_2": ["bunker", 2, 2, 1, 0, 2, 200, 2, "military"],
                      "bunker_3": ["bunker", 2, 2, 1, 0, 2, 240, 2, "military"],
                      "bunker_4": ["bunker", 1, 1, 1, 0, 2, 160, 2, "military"],
                      "bunker_5": ["bunker", 2, 2, 1, 0, 2, 200, 2, "military"],
                      "bunker_6": ["bunker", 2, 2, 1, 0, 2, 240, 2, "military"],
                      "ruins_1": ["ruins", 1, 1, 0, 0, 2, 120, 6, "misc"],
                      "ruins_2": ["ruins", 1, 1, 0, 0, 2, 120, 6, "misc"],
                      "ruins_3": ["ruins", 1, 1, 0, 0, 2, 120, 6, "misc"],
                      "ruins_4": ["ruins", 1, 1, 0, 0, 2, 120, 6, "misc"],
                      "fighter_plane_1": ["aeroplane", 2, 2, 0, 0, 1, 120, 0, "misc"],
                      "fighter_plane_2": ["aeroplane", 2, 2, 0, 0, 1, 120, 0, "misc"],
                      "supply_truck_1": ["truck", 1, 1, 0, 0, 1, 120, 0, "misc"],
                      "supply_truck_2": ["truck", 1, 1, 0, 0, 1, 120, 1, "misc"]}
