...
def build_infantry():
    infantry = {"rm": ["RIFLE", "rifleman", 10, 5, 3, ["RIFLES", "EXTRA_GRENADES", "PLACE_MINES", "SATCHEL_CHARGE"]],
                "sm": ["SMG", "shock troops", 15, 3, 2, ["SMG", "EXTRA_GRENADES", "SATCHEL_CHARGE", ""]],
                "mg": ["MG", "machine-gunner", 15, 2, 3, ["SUPPORT_FIRE", "", "", ""]],
                "hg": ["MG", "heavy-machine-gunner", 15, 2, 3, ["HEAVY_SUPPORT_FIRE", "DAMAGE_TRACKS", "", ""]],
                "at": ["ANTI_TANK", "anti-tank rifleman", 15, 2, 3, ["HEAVY_RIFLES", "DAMAGE_TRACKS", "", ""]],
                "en": ["ENGINEER", "engineer", 10, 2, 1, ["SIDE_ARMS", "REPAIR", "PLACE_MINES", ""]],
                "gr": ["RIFLE", "grenadier", 15, 3, 3, ["RIFLES", "RIFLE_GRENADE", "SATCHEL_CHARGE", ""]],
                "gc": ["ENGINEER", "crewman", 10, 5, 1, ["SIDE_ARMS", "CREW", "SATCHEL_CHARGE", ""]],
...
def build_actions():
    action_items = {"BAIL_OUT": ["crew", "ORDERS", 1, 0, 0, "SELF", "BAILING_OUT", "NEVER", 0, 0, 0, 0, 0, 0, 0, ""],
                    ...
                    "DIRECT_ORDER": ["radio", "ORDERS", 1, 3, 0, "ALLIES", "DIRECT_ORDER", "SUPPORT", 0, 0, 0, 0, 0, 0,
                                     0, ""],
                    "ENTER_BUILDING": ["building", "ORDERS", 1, 0, 0, "BUILDING", "ENTER_BUILDING", "NEVER", 0, 0, 0, 0,
                                       0, 0, 0, ""],
                    "FAST_RELOAD": ["supply", "ORDERS", 1, 6, 1, "SELF", "FAST_RELOAD", "SPECIAL", 0, 0, 0, 0, 0, 0, 0,
                                    ""],
                    "LOAD_TROOPS": ["load", "ORDERS", 1, 0, 0, "FRIEND", "LOAD_TROOPS", "NEVER", 0, 0, 0, 0, 0, 0, 0,
                                    ""],
                    "MARK_TARGET": ["spotting", "ORDERS", 1, 1, 0, "ENEMY", "MARKING", "SUPPORT", 0, 0, 0, 0, 0, 0, 0,
                                    ""],
                    "RADIO_JAMMING": ["radio", "ORDERS", 2, 3, 1, "ENEMY", "RADIO_JAMMING", "SUPPORT", 1, 0, 0, 0, 0, 0,
                                      0, ""],
                    "CHANGE_FREQUENCIES": ["radio", "ORDERS", 2, 3, 0, "SELF", "REMOVE_JAMMING", "SUPPORT", 1, 0, 0, 0,
                                           0, 0, 0, ""],
                    ...
                    "RAPID_FIRE": ["rapid_fire", "ORDERS", 1, 3, 1, "SELF", "RAPID_FIRE", "SPECIAL", 1, 2, 0, 0, 0, 0,
                                   0, ""],
                    "RECOVER_MORALE": ["radio", "ORDERS", 1, 0, 0, "ALLIES", "RECOVER", "SUPPORT", 0, 0, 0, 0, 0, 0, 0,
                                       ""],
                    ...
                    "OVERWATCH": ["radio", "ORDERS", 1, 3, 0, "SELF", "SET_OVERWATCH", "NEVER", 1, 0, 0, 0, 0, 0, 0,
                                  ""],
                    "SPOTTING": ["spotting", "ORDERS", 2, 0, 0, "SELF", "SPOTTING", "NEVER", 0, 0, 0, 0, 0, 0, 0, ""],
                    "STEADY_AIM": ["aimed_shot", "ORDERS", 1, 3, 1, "SELF", "STEADY_AIM", "SPECIAL", 1, 2, 0, 0, 0, 0,
                                   0, ""],
                    "SPECIAL_AMMO": ["rapid_fire", "ORDERS", 1, 3, 1, "SELF", "SPECIAL_AMMO", "SPECIAL", 1, 2, 0, 0, 0,
                                     0, 0, ""],
                    ...
                    "UNLOAD_TROOPS": ["unload", "ORDERS", 1, 0, 0, "SELF", "UNLOAD_TROOPS", "NEVER", 1, 0, 0, 0, 0, 0,
                                      0, ""],
                    "SPOTTER_PLANE": ["spotting", "ORDERS", 2, 3, 1, "AIRCRAFT", "SPOTTER_PLANE", "AIR_SUPPORT", 0, 0,
                                      0, 0, 0, 0, 0, ""],
                    "AIR_STRIKE": ["explosion", "ORDERS", 2, 3, 1, "AIRCRAFT", "AIR_STRIKE", "AIR_SUPPORT", 0, 0, 0, 0,
                                   0, 3, 0, ""],
                    ...
                    "RANGED_SUPPORT_FIRE": ["explosion", "WEAPON", 1, 3, 0, "MAP", "ARTILLERY_EXPLOSION", "ARTILLERY",
                                            0, 0, 0, 0.5, 1.5, 1, 2, ""],
                    "HIGH_EXPLOSIVE": ["explosion", "WEAPON", 1, 0, 0, "ENEMY", "EXPLOSION", "SOFT_TARGET", 0, 0, 0.6,
                                       0.5, 2, 1, 3, ""],
                    "THROW_GRENADE": ["grenade", "WEAPON", 1, 3, 0, "ENEMY", "GRENADE_EXPLOSION", "HARD_TARGET", 0, 0,
                                      0, 2, 2, 1, 2, ""],
                    "SATCHEL_CHARGE": ["grenade", "WEAPON", 1, 3, 0, "ENEMY", "GRENADE_EXPLOSION", "HARD_TARGET", 0, 0,
                                       0, 4, 4, 1, 8, ""],
                    "RIFLE_GRENADE": ["grenade", "WEAPON", 1, 3, 0, "ENEMY", "GRENADE_EXPLOSION", "HARD_TARGET", 0, 0,
                                      0.6, 2, 2, 1, 2, ""],
                    "SHOOT": ["shoot", "WEAPON", 1, 0, 0, "ENEMY", "HIT", "NORMAL", 0, 0, 1, 1.2, 1.2, 1, 1, ""],
                    "RIFLES": ["rifles", "WEAPON", 1, 0, 0, "ENEMY", "HIT", "SOFT_TARGET", 0, 0, 1, 0.5, 1.5, 1, 1, ""],
                    "SNIPER_RIFLES": ["aimed_shot", "WEAPON", 1, 0, 0, "ENEMY", "HIT", "SOFT_TARGET", 0, 0, 2, 1, 2, 1,
                                      2, ""],
                    "ASSAULT_RIFLES": ["rifles", "WEAPON", 1, 0, 0, "ENEMY", "HIT", "SOFT_TARGET", 0, 0, 1, 0.5, 1, 3,
                                       1, ""],
                    "HEAVY_RIFLES": ["rifles", "WEAPON", 1, 0, 0, "ENEMY", "HIT", "NORMAL", 0, 0, 1, 4, 4, 1, 2, ""],
                    "SMG": ["smg", "WEAPON", 0, 1, 0, "ENEMY", "HIT", "SOFT_TARGET", 0, 0, 0.6, 0.5, 1, 3, 1, ""],
                    "SIDE_ARMS": ["side_arms", "WEAPON", 1, 0, 0, "ENEMY", "HIT", "SOFT_TARGET", 0, 0, 1, 0.5, 1, 3, 1,
                                  ""],
                    "SUPPORT_FIRE": ["support_fire", "WEAPON", 1, 0, 0, "ENEMY", "HIT", "SOFT_TARGET", 0, 0, 1, 0.5, 1,
                                     4, 2, ""],
                    "HEAVY_SUPPORT_FIRE": ["support_fire", "WEAPON", 1, 0, 0, "ENEMY", "HIT", "NORMAL", 0, 0, 1, 2, 2,
                                           3, 2, ""],
                    "DAMAGE_TRACKS": ["tracks", "WEAPON", 2, 3, 0, "ENEMY", "HIT_TRACKS", "HARD_TARGET", 0, 0, 0.3, 0.5,
                                      0.5, 1, 1, ""],
                    "BURST_FIRE": ["shoot", "WEAPON", 1, 1, 0, "ENEMY", "HIT", "SOFT_TARGET", 0, 0, 0.6, 1, 1, 3, 1,
                                   ""],
                    "ANTI_TANK": ["shoot", "WEAPON", 1, 0, 0, "ENEMY", "HIT", "HARD_TARGET", 0, 0, 1, 1.8, 1, 1, 1, ""],
                    "AIMED_SHOT": ["aimed_shot", "WEAPON", 2, 3, 0, "ENEMY", "HIT", "NORMAL", 0, 0, 1.5, 1, 1.2, 1, 1,
                                   ""],
                    "CALLED_SHOT": ["aimed_shot", "WEAPON", 1, 0, 1, "ENEMY", "HIT", "HARD_TARGET", 0, 0, 1, 1.2, 2, 1,
                                    2, ""],
                    "QUICK_FIRE": ["rapid_fire", "WEAPON", 0, 3, 1, "ENEMY", "HIT", "NORMAL", 0, 0, 0.8, 1, 1, 1, 1,
                                   ""],
                    "ARMOR_PIERCING": ["aimed_shot", "WEAPON", 1, 0, 0, "ENEMY", "HIT", "HARD_TARGET", 0, 0, 1, 2.2, 1,
                                       1, 2, ""],
                    "SUPPRESSING_FIRE": ["rapid_fire", "WEAPON", 1, 3, 1, "ENEMY", "HIT", "SOFT_TARGET", 0, 0, 0.6, 1,
                                         1, 4, 2, ""],
                    "TARGET_TRACKS": ["tracks", "WEAPON", 2, 3, 1, "ENEMY", "HIT_TRACKS", "HARD_TARGET", 0, 0, 0.3, 0.5,
                                      0.5, 1, 1, ""],
                    "SMALL_ROCKETS": ["explosion", "WEAPON", 2, 3, 0, "MAP", "ROCKET_EXPLOSION", "ARTILLERY", 0, 0, 0.3,
                                      0.5, 1.5, 12, 3, ""],
                    "MEDIUM_ROCKETS": ["explosion", "WEAPON", 2, 3, 0, "MAP", "ROCKET_EXPLOSION", "ARTILLERY", 0, 0, 0,
                                       0.5, 2, 9, 3, ""],
                    ...
                    "SMOKE_ROCKETS": ["explosion", "WEAPON", 2, 3, 1, "MAP", "ROCKET_SMOKE", "SMOKE", 0, 0, 0.3, 0, 0,
                                      6, 0, ""],
                    "SMOKE_SHELLS": ["smoke", "WEAPON", 2, 1, 0, "MAP", "SMOKE", "SMOKE", 0, 0, 0.3, 0, 0, 1, 0, ""]}
