...
def build_test_vehicles():
    test_vehicles = {
        ...
        "HRR_primitive_tank_1": ["PST-I-PANZER", "pristis tank", 1, 1, 3, 1, "TRACKED", "medium gun", "", "short gun",
                                 "short gun", [3, 1], 30, ["RIVETS", "COMMANDER", "", ""], "HOLD", 4, 6],
        ...
        "HRR_landing_vehicle_2": ["SQS-II-TANSPORTEUR", "squalus landing vehicle", 1, 1, 1, 0, "TRACKED", "medium gun",
                                  "machinegun", "", "", [2, 1], 30, ["RADIO", "COMMANDER", "", ""], "ARTILLERY", 3, 6],
        "HRR_landing_vehicle_3": ["SQS-III-TANSPORTEUR", "squalus landing vehicle", 1, 1, 1, 1, "TRACKED", "", "",
                                  "short gun", "medium autocannon", [2, 1], 30, ["RADIO", "COMMANDER", "", ""], "HOLD",
                                  3, 6],
        ...
        "VIN_large_gun_tank_1": ["UN3-KANON", "ullr gun carrier", 1, 1, 2, 0, "TRACKED", "", "", "support gun",
                                 "medium machinegun", [4, 2], 30, ["RADIO", "RIVETS", "COMMANDER", ""], "HOLD", 3, 6],
        ...
        "VIN_medium_support_gun": ["BN-29-ARTILLERI", "support gun", 0, 0, 1, 0, "GUN_CARRIAGE", "", "",
                                   "light artillery", "", [1, 0], 25, ["RADIO", "", "", ""], "ARTILLERY", 1, 5],
...
def build_components():
    vehicle_items = {0: ["gun mantlet", "armor", 1, 1, 0, 6, 1, "", ["mantlet", ""], "description goes here"],
                     ...
                     59: ["super heavy gun", "weapon", 2, 3, 0, 6, 12, "", ["at1", "very_slow"],
                          "description goes here"],
                     60: ["breech mortar", "weapon", 1, 1, 0, 6, 9, "", ["mortar", "slow"], "description goes here"],
                     61: ["heavy breech mortar", "weapon", 1, 2, 0, 6, 12, "", ["mortar", "very_slow"],
                          "description goes here"],
                     62: ["light breech mortar", "weapon", 1, 1, 0, 6, 6, "", ["mortar", "slow"],
                          "description goes here"],
...
def build_actions():
    action_items = {"BAIL_OUT": ["crew", "ORDERS", 1, 0, 0, "SELF", "BAILING_OUT", "NEVER", 0, 0, 0, 0, 0, 0, 0, ""],
                    ...
                    "UNLOAD_TROOPS": ["unload", "ORDERS", 1, 0, 0, "SELF", "UNLOAD_TROOPS", "NEVER", 1, 0, 0, 0, 0, 0,
                                      0, ""],
                    "SPOTTER_PLANE": ["spotting", "ORDERS", 2, 12, 1, "AIRCRAFT", "SPOTTER_PLANE", "AIR_SUPPORT", 1, 0,
                                      0, 0, 0, 0, 0, ""],
                    "PARADROP": ["paradrop", "ORDERS", 2, 12, 1, "AIRCRAFT", "DROP_TROOPS", "AIR_SUPPORT", 1, 0, 0, 0,
                                 0, 0, 0, ""],
                    "AIR_STRIKE": ["explosion", "ORDERS", 2, 12, 1, "AIRCRAFT", "AIR_STRIKE", "AIR_SUPPORT", 1, 0, 0, 0,
                                   0, 3, 0, ""],
                    ...
                    "HIGH_EXPLOSIVE": ["explosion", "WEAPON", 1, 1, 0, "ENEMY", "HIT_SPLASH", "DIRECT_ATTACK", 0, 0,
                                       0.8, 0.25, 2, 1, 2, ""],
                    "THROW_GRENADE": ["grenade", "WEAPON", 2, 3, 0, "ENEMY", "GRENADE_EXPLOSION", "DIRECT_ATTACK", 0, 0,
                                      0.4, 4, 4, 1, 4, ""],
                    "SATCHEL_CHARGE": ["grenade", "WEAPON", 2, 12, 0, "ENEMY", "GRENADE_EXPLOSION", "DIRECT_ATTACK", 0,
                                       0, 0, 6, 6, 1, 6, ""],
