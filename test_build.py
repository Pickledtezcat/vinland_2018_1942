...
def build_actions():
    action_items = {"BAIL_OUT": ["crew", "ORDERS", 1, 0, 0, "SELF", "BAILING_OUT", "NEVER", 0, 0, 0, 0, 0, 0, 0, ""],
                    ...
                    "RANGED_SUPPORT_FIRE": ["explosion", "WEAPON", 1, 3, 0, "MAP", "ARTILLERY_EXPLOSION", "ARTILLERY",
                                            0, 0, 0, 0.5, 1.5, 1, 2, ""],
                    "HIGH_EXPLOSIVE": ["explosion", "WEAPON", 1, 0, 0, "ENEMY", "EXPLOSION", "DIRECT_ATTACK", 0, 0, 0.6,
                                       0.5, 2, 1, 3, ""],
                    ...
                    "DAMAGE_TRACKS": ["tracks", "WEAPON", 2, 3, 0, "ENEMY", "HIT_TRACKS", "DIRECT_ATTACK", 0, 0, 1, 1,
                                      1, 2, 1, ""],
                    "BURST_FIRE": ["shoot", "WEAPON", 1, 1, 0, "ENEMY", "HIT", "DIRECT_ATTACK", 0, 0, 0.6, 1, 1, 3, 1,
                                   ""],
                    ...
                    "AIMED_SHOT": ["aimed_shot", "WEAPON", 2, 3, 0, "ENEMY", "HIT", "DIRECT_ATTACK", 0, 0, 1.5, 1, 1.2,
                                   1, 1, ""],
                    "CALLED_SHOT": ["aimed_shot", "WEAPON", 1, 0, 1, "ENEMY", "HIT", "DIRECT_ATTACK", 0, 0, 1, 1.2, 2,
                                    1, 2, ""],
                    "QUICK_FIRE": ["rapid_fire", "WEAPON", 0, 3, 1, "ENEMY", "HIT", "DIRECT_ATTACK", 0, 0, 0.8, 1, 1, 1,
                                   1, ""],
                    "ARMOR_PIERCING": ["aimed_shot", "WEAPON", 1, 0, 0, "ENEMY", "HIT", "DIRECT_ATTACK", 0, 0, 1, 2.2,
                                       1, 1, 2, ""],
