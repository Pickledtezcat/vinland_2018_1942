...
def build_actions():
    action_items = {"BAIL_OUT": ["crew", "ORDERS", 1, 0, 0, "SELF", "BAILING_OUT", "NEVER", 0, 0, 0, 0, 0, 0, 0, ""],
                    ...
                    "UNLOAD_TROOPS": ["unload", "ORDERS", 1, 0, 0, "SELF", "UNLOAD_TROOPS", "NEVER", 1, 0, 0, 0, 0, 0,
                                      0, ""],
                    "SPOTTER_PLANE": ["spotting", "ORDERS", 2, 3, 1, "AIRCRAFT", "SPOTTER_PLANE", "AIR_SUPPORT", 1, 0,
                                      0, 0, 0, 0, 0, ""],
                    "PARADROP": ["paradrop", "ORDERS", 2, 3, 1, "AIRCRAFT", "DROP_TROOPS", "AIR_SUPPORT", 1, 0, 0, 0, 0,
                                 0, 0, ""],
                    "AIR_STRIKE": ["explosion", "ORDERS", 2, 3, 1, "AIRCRAFT", "AIR_STRIKE", "AIR_SUPPORT", 1, 0, 0, 0,
                                   0, 3, 0, ""],
                    ...
                    "RANGED_SUPPORT_FIRE": ["explosion", "WEAPON", 1, 3, 0, "MAP", "ARTILLERY_EXPLOSION", "ARTILLERY",
                                            0, 0, 0.1, 0.5, 1.5, 1, 2, ""],
                    "HIGH_EXPLOSIVE": ["explosion", "WEAPON", 2, 0, 0, "ENEMY", "EXPLOSION", "DIRECT_ATTACK", 0, 0, 1,
                                       0.5, 2, 1, 3, ""],
                    ...
                    "AIMED_SHOT": ["aimed_shot", "WEAPON", 2, 3, 0, "ENEMY", "HIT", "DIRECT_ATTACK", 0, 0, 1.5, 1, 1.2,
                                   1, 1, ""],
                    "CALLED_SHOT": ["aimed_shot", "WEAPON", 1, 1, 1, "ENEMY", "HIT", "DIRECT_ATTACK", 0, 0, 1, 1.2, 2,
                                    1, 2, ""],
