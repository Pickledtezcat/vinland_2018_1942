...
def build_actions():
    action_items = {
        ...
        "TARGET_RECOGNITION": ["spotting", "ORDERS", 2, 3, 1, "ENEMY", "RECOGNITION", "OFFENSIVE_SUPPORT", 0, 0, 0, 0,
                               0, 0, 0, ""],
        "RADIO_CONFUSION": ["radio", "ORDERS", 2, 3, 1, "ENEMY", "CONFUSION", "OFFENSIVE_SUPPORT", 0, 0, 0, 0, 0, 0, 0,
                            ""],
        "RADIO_JAMMING": ["radio", "ORDERS", 2, 3, 1, "ENEMY", "RADIO_JAMMING", "OFFENSIVE_SUPPORT", 0, 0, 0, 0, 0, 0,
                          0, ""],
        ...
        "OVERDRIVE": ["wheels", "ORDERS", 0, 3, 1, "SELF", "OVERDRIVE", "NEVER", 0, 2, 0, 0, 0, 0, 0, ""],
        ...
        "ARTILLERY_SHOT": ["explosion", "WEAPON", 1, 0, 0, "MAP", "ARTILLERY_EXPLOSION", "ARTILLERY", 0, 0, 0.8, 0.5, 2,
                           1, 2, ""],
        "ZEROED_ARTILLERY": ["explosion", "WEAPON", 1, 3, 1, "MAP", "ARTILLERY_EXPLOSION", "ARTILLERY", 0, 0, 1, 0.5, 2,
                             1, 2, ""],
        "RANGED_SUPPORT_FIRE": ["explosion", "WEAPON", 1, 3, 0, "MAP", "ARTILLERY_EXPLOSION", "ARTILLERY", 0, 0, 0.1,
                                0.5, 1.5, 1, 2, ""],
        "CLOSE_SUPPORT_FIRE": ["explosion", "WEAPON", 1, 0, 0, "ENEMY", "ARTILLERY_EXPLOSION", "DIRECT_ATTACK", 0, 0, 1,
                               0.5, 1.5, 1, 2, ""],
        ...
        "LARGE_ROCKETS": ["rockets", "WEAPON", 1, 3, 0, "MAP", "ROCKET_EXPLOSION", "ARTILLERY", 1, 0, 0, 0.5, 2.5, 6, 3,
                          ""],
        "SMOKE_ROCKETS": ["rockets", "WEAPON", 1, 3, 1, "MAP", "ROCKET_SMOKE", "SMOKE", 1, 0, 0.3, 0, 0, 6, 0, ""],
