...
def build_actions():
    action_items = {"AMBUSH": ["spotting", "ORDERS", 2, 1, 0, "SELF", "AMBUSH", 0, 0, 0, 0, 0, ""],
                    ...
                    "ARTILLERY_SHOT": ["explosion", "WEAPON", 2, 0, 0, "MAP", "ARTILLERY_EXPLOSION", 0.2, 0.2, 3, 1, 3,
                                       ""],
                    ...
                    "HASTY_BARRAGE": ["explosion", "WEAPON", 1, 3, 0, "MAP", "ARTILLERY_EXPLOSION", 0.1, 0.2, 3, 1, 3,
                                      ""],
                    "THROW_GRENADE": ["grenade", "WEAPON", 1, 3, 0, "ENEMY", "GRENADE_EXPLOSION", 0.2, 2, 2, 1, 2, ""],
                    "SATCHEL_CHARGE": ["grenade", "WEAPON", 1, 3, 0, "ENEMY", "GRENADE_EXPLOSION", 0.2, 4, 4, 1, 4, ""],
