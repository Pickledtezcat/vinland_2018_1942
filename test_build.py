...
def build_actions():
    action_items = {"AMBUSH": ["spotting", "ORDERS", 2, 1, 0, "SELF", "AMBUSH", -1, 0, 0, 0, 0, 0, ""],
                    "ANTI_ARICRAFT_FIRE": ["aa_fire", "ORDERS", 2, 1, 0, "SELF", "ANTI_AIRCRAFT", -1, 0, 0, 0, 0, 0,
                                           ""],
                    ...
                    "SPOTTING": ["spotting", "ORDERS", 2, 1, 0, "SELF", "SPOTTING", 0, 0, 0, 0, 0, 0, ""],
                    "MARK_TARGET": ["spotting", "ORDERS", 1, 1, 1, "ENEMY", "MARKING", 0, 0, 0, 0, 0, 0, ""],
                    "CLEAR_JAM": ["cancel", "WEAPON", 2, 1, 0, "SELF", "CLEAR_JAM", 0, 0, 0, 0, 0, 0, ""],
                    "TARGET_TRACKS": ["tracks", "WEAPON", 2, 1, 0, "ENEMY", "TARGET_TRACKS", 0, 0.5, 0.5, 0.5, 1, 1,
                                      ""],
                    "HIGH_EXPLOSIVE": ["explosion", "WEAPON", 1, 1, 0, "ENEMY", "EXPLOSION", 0, 0.8, 0.2, 3, 1, 3, ""],
                    ...
                    "LARGE_ROCKETS": ["explosion", "WEAPON", 2, 3, 0, "MAP", "ROCKET_EXPLOSION", 0, 0.1, 0.2, 3, 3, 3,
                                      ""],
                    "SMOKE_ROCKETS": ["explosion", "WEAPON", 2, 3, 0, "MAP", "ROCKET_SMOKE", 0, 0.25, 0, 0, 0, 0, ""],
                    ...
                    "SPECIAL_AMMO": ["aimed_shot", "WEAPON", 1, 0, 1, "ENEMY", "HIT", 0, 1.5, 2, 2, 1, 2, ""],
                    "SNAP_SHOT": ["shoot", "WEAPON", 0, 6, 0, "ENEMY", "HIT", 0, 0.5, 1, 1, 1, 1, ""],
                    "SMOKE_SHELLS": ["smoke", "WEAPON", 1, 1, 0, "MAP", "SMOKE", 0, 1, 0, 0, 0, 0, ""]}
