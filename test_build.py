...
def build_test_vehicles():
    test_vehicles = {
        ...
        "HRR_scout_car_2": ["ASR-II-CARRO", "anser scout car", 2, 1, 1, 0, "TRACKED", "", "", "medium machinegun", "",
                            [1, 1], 15, ["RADIO", "PERISCOPE", "COMMANDER", ""], "JAMMER", 1, 3],
        "HRR_scout_tank_1": ["PLM-I-PANZER", "pullum scout tank", 2, 2, 2, 0, "TRACKED", "miniature gun", "", "", "",
                             [2, 1], 20, ["RIVETS", "COMMANDER", "", ""], "HOLD", 2, 4],
        "HRR_scout_gun_1": ["CPA-I-GESHUTZ", "capra scout gun", 2, 2, 2, 0, "TRACKED", "", "", "medium gun", "", [1, 1],
                            15, ["RIVETS", "OPEN_TOP", "", ""], "HOLD", 2, 3],
        "HRR_medium _aa_tank": ["CTS-IIC-LUFTTELUM", "cetus medium tank", 2, 2, 2, 0, "TRACKED", "light autocannon", "",
                                "", "", [2, 2], 25, ["RADIO", "AA_TURRET", "", ""], "ANTI_AIR", 3, 5],
        ...
        "HRR_medium_scout_tank": ["CTS-IIE-PANZER", "cetus medium tank", 2, 2, 3, 0, "TRACKED", "", "",
                                  "anti tank rifle", "medium machinegun", [2, 2], 25,
        ...
        "HRR_medium_escort_tank": ["CTS-IIS-PANZER", "cetus medium tank", 2, 2, 2, 1, "TRACKED", "light gun",
                                   "medium machinegun", "", "", [3, 2], 25, ["RADIO", "COMMANDER", "", ""], "HOLD", 2,
                                   5],
        "HRR_aquatic_truck_scout": ["CND-VE-CARRO", "canard truck", 2, 1, 1, 1, "WHEELED", "anti tank rifle",
                                    "medium machinegun", "", "", [2, 1], 30, ["RADIO", "COMMANDER", "", ""], "HOLD", 2,
                                    6],
        ...
        "HRR_primitive_tank_1": ["PST-I-PANZER", "pristis tank", 1, 1, 3, 1, "TRACKED", "medium gun", "",
                                 "miniature gun", "miniature gun", [3, 1], 30, ["RIVETS", "COMMANDER", "", ""], "HOLD",
                                 4, 6],
        ...
        "HRR_landing_vehicle_2": ["SQS-II-TANSPORTEUR", "squalus landing vehicle", 1, 1, 1, 0, "TRACKED", "support gun",
                                  "medium machinegun", "", "", [2, 1], 30, ["RADIO", "COMMANDER", "", ""], "ARTILLERY",
                                  3, 6],
        "HRR_landing_vehicle_3": ["SQS-III-TANSPORTEUR", "squalus landing vehicle", 1, 1, 1, 1, "TRACKED", "", "",
                                  "light gun", "light gun", [2, 1], 30, ["RADIO", "COMMANDER", "", ""], "HOLD", 3, 6],
        ...
        "HRR_infantry_autocannon": ["MGN-CELERITELUM", "light autocannon", 1, 1, 1, 0, "GUN_CARRIAGE", "", "",
                                    "medium autocannon", "", [0, 0], 15, ["", "", "", ""], "HOLD", 1, 3],
        ...
        "HRR_static_anti_air_gun": ["PVS-LUFTTELUM", "anti air gun", 0, 0, 1, 1, "GUN_CARRIAGE", "medium autocannon",
                                    "", "", "", [1, 0], 20, ["AA_TURRET", "", "", ""], "ANTI_AIR", 1, 4],
        "HRR_infantry_gun": ["PVS-INFANTRIEKANON", "light autocannon", 1, 1, 1, 0, "GUN_CARRIAGE", "", "",
                             "miniature gun", "", [0, 0], 15, ["", "", "", ""], "HOLD", 1, 3],
        "VIN_primitive_tank_3": ["JT-4-KAMPV", "jotun tank", 1, 1, 3, 0, "TRACKED", "", "", "medium machinegun",
        ...
        "VIN_scout_tank_1": ["KR-1-KAMPV", "kylling scout tank", 2, 2, 2, 1, "TRACKED", "miniature gun", "", "", "",
                             [2, 1], 20, ["RIVETS", "COMMANDER", "", ""], "HOLD", 2, 4],
        ...
        "VIN_scout_car_1": ["DF-2-VOGN", "dverg scout car", 3, 1, 1, 1, "WHEELED", "medium autocannon",
                            "anti tank rifle", "", "", [1, 1], 25, ["RADIO", "PERISCOPE", "COMMANDER", ""], "JAMMER", 2,
                            5],
        "VIN_scout_car_2": ["DF-6-VOGN", "dverg scout car", 3, 1, 1, 1, "WHEELED", "light autocannon", "", "machinegun",
                            "", [1, 1], 25, ["RADIO", "TACTICAL_RADIO", "COMMANDER", ""], "JAMMER", 2, 5],
        "VIN_light_tank_1": ["HF-1-KAMPV", "huginn light tank", 2, 2, 3, 1, "TRACKED", "light gun", "", "machinegun",
                             "", [3, 2], 25, ["RADIO", "RIVETS", "COMMANDER", ""], "HOLD", 2, 5],
        "VIN_command_tank_1": ["MP-1-KOMMANDO", "muninn command tank", 2, 2, 3, 0, "TRACKED", "", "", "anti tank rifle",
                               "machinegun", [2, 2], 20, ["RADIO", "COMMAND_RADIO", "RIVETS", "COMMANDER"], "SUPPORT",
                               1, 4],
        "VIN_large_gun_tank_1": ["UN3-KANON", "ullr gun carrier", 1, 1, 2, 0, "TRACKED", "", "", "support gun",
                                 "machinegun", [4, 2], 30, ["RADIO", "RIVETS", "COMMANDER", ""], "HOLD", 3, 6],
        "VIN_large_tank_1": ["TK-1-KAMPV", "thrud large tank", 1, 1, 2, 1, "TRACKED", "medium gun", "light autocannon",
                             "machinegun", "", [3, 2], 30, ["RADIO", "RIVETS", "COMMANDER", ""], "HOLD", 3, 6],
        ...
        "VIN_infantry_mg": ["MR-05-MASKINGEVAER", "machine gun", 1, 1, 1, 0, "GUN_CARRIAGE", "", "",
                            "medium machinegun", "", [0, 0], 10, ["", "", "", ""], "HOLD", 1, 2]}
...
def build_components():
    vehicle_items = {0: ["gun mantlet", "armor", 1, 1, 0, 6, 1, "", ["mantlet", ""], "description goes here"],
                     ...
                     42: ["twin heavy autocannon", "weapon", 1, 3, 0, 6, 4, "", ["burst_fire", "twin_mount"],
                          "description goes here"],
                     43: ["anti tank rifle", "weapon", 1, 1, 0, 6, 2, "", ["at2", "quick"], "description goes here"],
                     44: ["miniature gun", "weapon", 1, 3, 0, 6, 5, "", ["cheap", "slow"], "description goes here"],
                     ...
                     54: ["support gun", "weapon", 1, 3, 0, 6, 8, "", ["indirect", "slow"], "description goes here"],
                     ...
                     60: ["heavy breech mortar", "weapon", 1, 2, 0, 6, 15, "", ["mortar", "very_slow"],
                          "description goes here"],
                     61: ["light breech mortar", "weapon", 1, 1, 0, 6, 5, "", ["mortar", "slow"],
                          "description goes here"],
...
def build_actions():
    action_items = {"BAIL_OUT": ["crew", "ORDERS", 1, 0, 0, "SELF", "BAILING_OUT", "NEVER", 0, 0, 0, 0, 0, 0, 0, ""],
                    ...
                    "ENTER_BUILDING": ["building", "ORDERS", 1, 0, 0, "BUILDING", "ENTER_BUILDING", "NEVER", 0, 0, 0, 0,
                                       0, 0, 0, ""],
                    "FAST_RELOAD": ["supply", "ORDERS", 1, 6, 1, "SELF", "FAST_RELOAD", "NEVER", 0, 0, 0, 0, 0, 0, 0,
                                    ""],
                    ...
                    "RADIO_JAMMING": ["radio", "ORDERS", 2, 3, 1, "ENEMY", "RADIO_JAMMING", "OFFENSIVE_SUPPORT", 0, 0,
                                      0, 0, 0, 0, 0, ""],
                    "CHANGE_FREQUENCIES": ["radio", "ORDERS", 2, 0, 0, "SELF", "REMOVE_JAMMING", "NORMAL", 0, 0, 0, 0,
                                           0, 0, 0, ""],
                    ...
                    "STEADY_AIM": ["aimed_shot", "ORDERS", 1, 4, 1, "SELF", "STEADY_AIM", "DEFEND", 1, 3, 0, 0, 0, 0, 0,
                                   ""],
                    "SPECIAL_AMMO": ["rapid_fire", "ORDERS", 1, 4, 1, "SELF", "SPECIAL_AMMO", "DEFEND", 1, 3, 0, 0, 0,
                                     0, 0, ""],
                    "TOGGLE_BUTTONED_UP": ["spotting", "ORDERS", 1, 0, 0, "SELF", "TOGGLE_BUTTONED_UP", "NORMAL", 0, 0,
                                           0, 0, 0, 0, 0, ""],
                    "TOGGLE_STANCE": ["crew", "ORDERS", 1, 0, 0, "SELF", "TOGGLE_PRONE", "NORMAL", 0, 0, 0, 0, 0, 0, 0,
                                      ""],
                    ...
                    "UNLOAD_TROOPS": ["unload", "ORDERS", 1, 0, 0, "SELF", "UNLOAD_TROOPS", "NEVER", 1, 0, 0, 0, 0, 0,
                                      0, ""],
                    "SPOTTER_PLANE": ["spotting", "ORDERS", 2, 6, 1, "AIRCRAFT", "SPOTTER_PLANE", "AIR_SUPPORT", 1, 0,
                                      0, 0, 0, 0, 0, ""],
                    "PARADROP": ["paradrop", "ORDERS", 2, 6, 1, "AIRCRAFT", "DROP_TROOPS", "AIR_SUPPORT", 1, 0, 0, 0, 0,
                                 0, 0, ""],
                    ...
                    "RANGED_SUPPORT_FIRE": ["explosion", "WEAPON", 1, 3, 0, "MAP", "ARTILLERY_EXPLOSION", "ARTILLERY",
                                            0, 0, 0.1, 0.5, 1.5, 1, 2, ""],
                    "CLOSE_SUPPORT_FIRE": ["explosion", "WEAPON", 1, 0, 0, "ENEMY", "ARTILLERY_EXPLOSION",
                                           "DIRECT_ATTACK", 0, 0, 1, 0.5, 1.5, 1, 2, ""],
                    "HIGH_EXPLOSIVE": ["explosion", "WEAPON", 1, 1, 0, "ENEMY", "HIT_SPLASH", "DIRECT_ATTACK", 0, 0,
                                       0.8, 0.25, 2, 1, 2, ""],
                    "THROW_GRENADE": ["grenade", "WEAPON", 2, 0, 0, "ENEMY", "GRENADE_EXPLOSION", "DIRECT_ATTACK", 0, 0,
                                      0.4, 4, 4, 1, 4, ""],
                    "SATCHEL_CHARGE": ["grenade", "WEAPON", 2, 3, 0, "ENEMY", "GRENADE_EXPLOSION", "DIRECT_ATTACK", 0,
                                       0, 0, 6, 6, 1, 6, ""],
                    "RIFLE_GRENADE": ["grenade", "WEAPON", 2, 0, 0, "ENEMY", "HIT_SPLASH", "DIRECT_ATTACK", 0, 0, 0.8,
                                      2, 4, 1, 4, ""],
                    ...
                    "SNIPER_RIFLES": ["aimed_shot", "WEAPON", 2, 0, 0, "ENEMY", "HIT", "DIRECT_ATTACK", 0, 0, 2, 2, 3,
                                      1, 1, ""],
                    "ASSAULT_RIFLES": ["rifles", "WEAPON", 1, 0, 0, "ENEMY", "HIT", "DIRECT_ATTACK", 0, 0, 1, 0, 1, 3,
                                       1, ""],
                    "HEAVY_RIFLES": ["rifles", "WEAPON", 2, 0, 0, "ENEMY", "HIT", "DIRECT_ATTACK", 0, 0, 1.2, 4, 4, 2,
                                     4, ""],
                    "SMG": ["smg", "WEAPON", 1, 0, 0, "ENEMY", "HIT", "DIRECT_ATTACK", 0, 0, 1, 0, 1, 4, 1, ""],
                    "SIDE_ARMS": ["side_arms", "WEAPON", 1, 0, 0, "ENEMY", "HIT", "DIRECT_ATTACK", 0, 0, 0.8, 0, 1, 3,
                                  1, ""],
                    "SUPPORT_FIRE": ["support_fire", "WEAPON", 2, 0, 0, "ENEMY", "HIT", "DIRECT_ATTACK", 0, 0, 1, 1, 1,
                                     12, 1, ""],
                    ...
                    "AIMED_SHOT": ["aimed_shot", "WEAPON", 1, 3, 0, "ENEMY", "HIT", "DIRECT_ATTACK", 0, 0, 1.5, 1.2,
                                   1.2, 1, 1, ""],
                    "CALLED_SHOT": ["aimed_shot", "WEAPON", 1, 3, 1, "ENEMY", "HIT", "DIRECT_ATTACK", 0, 0, 1, 1.2, 1,
                                    1, 4, ""],
                    "QUICK_FIRE": ["rapid_fire", "WEAPON", 0, 3, 1, "ENEMY", "HIT", "DIRECT_ATTACK", 0, 0, 1, 1, 1, 1,
                                   1, ""],
                    "ARMOR_PIERCING": ["aimed_shot", "WEAPON", 1, 0, 0, "ENEMY", "HIT", "DIRECT_ATTACK", 0, 0, 1.2, 2.2,
                                       1, 1, 2, ""],
                    "SUPPRESSING_FIRE": ["rapid_fire", "WEAPON", 1, 3, 1, "ENEMY", "HIT", "DIRECT_ATTACK", 0, 0, 0.8, 1,
                                         1, 8, 2, ""],
                    ...
                    "SMALL_ROCKETS": ["explosion", "WEAPON", 1, 3, 0, "MAP", "ROCKET_EXPLOSION", "ARTILLERY", 1, 0, 0.6,
                                      0.5, 1.5, 12, 3, ""],
                    "MEDIUM_ROCKETS": ["explosion", "WEAPON", 1, 3, 0, "MAP", "ROCKET_EXPLOSION", "ARTILLERY", 1, 0,
                                       0.3, 0.5, 2, 9, 3, ""],
                    "LARGE_ROCKETS": ["explosion", "WEAPON", 1, 3, 0, "MAP", "ROCKET_EXPLOSION", "ARTILLERY", 1, 0, 0,
                                      0.5, 2.5, 6, 3, ""],
                    "SMOKE_ROCKETS": ["explosion", "WEAPON", 1, 3, 1, "MAP", "ROCKET_SMOKE", "SMOKE", 1, 0, 0.3, 0, 0,
                                      6, 0, ""],
